...
public final class Application {
  ...
  public static void main(String[] args) {
    ...
    //create new playerLobby on application start
    final PlayerLobby playerLobby = new PlayerLobby();

    //create new sartingGames on application start
    //these games are not yet started and are waiting for both players to join
    final HashMap<String, Game> sartingGames = new HashMap<>();

    // inject the game center, freemarker engine and player lobby into web server
